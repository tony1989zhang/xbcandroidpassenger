 ...
 * 作用：添加发票
 */
@ContentView(R.layout.activity_add_invoice_layout)
public class AddInvoiceActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitleView(m_titleView, "发票", "保存");
        ...
        switch (v.getId()) {
            case R.id.title_right_tv:
                ...
                if (StringUtils.isEmpty(m_source_name)) {
                    ...
                    ConnectionManager.getInstance().invoiceAdd(this, (String) SPUtil.getInstance(this).get(Constants.USER_GID, ""), m_tv_tickethead_content.getText().toString(), new AddinvoiceOnDataLoadListener(AddinvoiceOnDataLoadListener.REQUEST_INVOICEADD_TYPE));
                } else {
            ...
            switch (request_type) {
                case REQUEST_INVOICEEDIT_TYPE:
                    ...
                    if (beanFromJson.errCode != -1) {
                        ConnectionManager.getInstance().expressInfoEdit(AddInvoiceActivity.this, (String) SPUtil.getInstance(AddInvoiceActivity.this).get(Constants.USER_GID, ""), invoiceListDataBean.express_info_gid, m_tv_sj_name_content.getText().toString(), m_tv_phone_content.getText().toString(), m_tv_address_content.getText().toString(), new EditInVoiceOnDataLoadListener(EditInVoiceOnDataLoadListener.REQUEST_EXPRESSINFOEDIT_TYPE));
                    }
                    break;
        ...
        public void OnLoadEnd(String ret) {
            switch (request_type) {
                case REQUEST_INVOICEADD_TYPE:
                    ...
                    XgoLog.d("invoiceAddbean:" + invoiceAddBean.toString());
                    if (invoiceAddBean.errCode != -1) {
                        ConnectionManager.getInstance().expressInfoAdd(AddInvoiceActivity.this, (String) SPUtil.getInstance(AddInvoiceActivity.this).get(Constants.USER_GID, ""), m_tv_sj_name_content.getText().toString(), m_tv_phone_content.getText().toString(),
                ...
                case REQUEST_EXPRESSINFOADD_TYPE:
                    ...
                    if (expressInfoAddBean.errCode != -1) {
                        ...
                        ConnectionManager.getInstance().bindExpressInfo(AddInvoiceActivity.this,
                                (String) SPUtil.getInstance(AddInvoiceActivity.this).get(Constants.USER_GID, ""),
