...
import com.lvchehui.www.xiangbc.city.City;
import com.lvchehui.www.xiangbc.city.DBHelper;
import com.lvchehui.www.xiangbc.city.DatabaseHelper;
import com.lvchehui.www.xiangbc.city.MyLetterListView;
import com.lvchehui.www.xiangbc.city.PingYinUtil;
...
public class CityActivity extends BaseActivity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					chooseCity(allCity_lists.get(position).getName());
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
									int position, long id) {
				chooseCity(city_result.get(position).getName());
				Toast.makeText(getApplicationContext(),
		...
		mAMapLocationClient.setLocationListener(myAMapLocationListener);
		InitAmapLocation();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // 定位
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						chooseCity(city_history.get(position));
						Toast.makeText(getApplicationContext(),
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
						chooseCity(city_hot.get(position).getName());
						Toast.makeText(getApplicationContext(),
	...
	public void chooseCity(String city){
		chooseCity = city;
		XgoLog.e("chooseCity:" + chooseCity);
		EventBus.getDefault().post(new CityEvent(chooseCity));
		finish();
	}
}