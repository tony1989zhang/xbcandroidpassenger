...
/**
 *  IOS类型的 进度条 可直接使用  调用SetProcess设置进度。
 */
//
//<com.lvchehui.www.view.RoundProgressBar
...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		roundWidth = mTypedArray.getDimension(R.styleable.RoundAngleImageView_roundWidth, 5);
