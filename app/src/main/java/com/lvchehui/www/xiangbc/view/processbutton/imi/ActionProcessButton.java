package com.lvchehui.www.xiangbc.view.processbutton.imi;
...
import com.lvchehui.www.xiangbc.view.processbutton.ProcessButton;
...
public class ActionProcessButton extends ProcessButton {
    ...
    private void init(Context context) {
        ...
        mColor1 = res.getColor(R.color.swipe_refrsh_color1);
        mColor2 = res.getColor(R.color.swipe_refrsh_color2);
        mColor3 = res.getColor(R.color.swipe_refrsh_color3);
        mColor4 = res.getColor(R.color.swipe_refrsh_color4);
    }
