package com.lvchehui.www.xiangbc.utils.updateHelper;
...
import com.lvchehui.www.xiangbc.utils.updateHelper.listener.OnUpdateListener;
import com.lvchehui.www.xiangbc.utils.updateHelper.pojo.UpdateInfo;
import com.lvchehui.www.xiangbc.utils.updateHelper.utils.HttpRequest;
import com.lvchehui.www.xiangbc.utils.updateHelper.utils.JSONHandler;
import com.lvchehui.www.xiangbc.utils.updateHelper.utils.NetWorkUtils;
import com.lvchehui.www.xiangbc.utils.updateHelper.utils.URLUtils;
...
public class UpdateHelper {
	...
	private void showUpdateUI(final UpdateInfo updateInfo) {
		...
		customDialog.setButtonsText("下次再说", "下载");
		customDialog.setTitle(updateInfo.getUpdateTips());
		customDialog.setCanceledOnTouchOutside(true);
		customDialog.setMessage(updateInfo.getChangeLog());
...
//		updateDialog.show();
	...
	private class AsyncCheck extends AsyncTask<String, Integer, UpdateInfo> {
		...
		protected UpdateInfo doInBackground(String... params) {
			...
			if (!URLUtils.isNetworkUrl(url)) {
				XgoLog.e("UpdateHelper:The URL is invalid." );
				return null;
			}
			try {
	...
	private void installApk(Uri data) {
		if (mContext != null) {
			...
			XgoLog.e("The context must not be null.");
		}
